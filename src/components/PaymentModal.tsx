          ...
          {mode === 'pay' ? (
            !paySuccess ? (
              ...
              >
                ...
                <button
                  onClick={onClose}
                  className="py-2.5 px-5 bg-[var(--app-primary)] text-white rounded-lg text-xs font-semibold"
                >
                  Close Window
                </button>
              </motion.div>
                ...
                <form onSubmit={handleUpdatePayment} className="space-y-4" id="update-billing-method-form">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-slate-300 rounded-lg py-2.5 px-3 bg-white text-slate-800 text-sm focus:ring-2 focus:ring-[var(--app-primary)] focus:border-transparent outline-none font-mono"
                      required
                    />
                  </div>
                  ...
                  <div className="flex justify-end space-x-3 pt-3 border-t border-slate-100">
                    ...
                    <button
                      type="submit"
                      className="py-2.5 px-5 bg-[var(--app-primary)] hover:bg-[var(--app-primary-hover)] text-white rounded-lg text-xs font-semibold transition-all shadow-md"
                    >
                      Save Changes
                    </button>
                  </div>
