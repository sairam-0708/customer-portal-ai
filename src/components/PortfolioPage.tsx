  ...
  return (
    <div className="space-y-8" id="portfolio-page-container">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" id="portfolio-stats-grid">
        ...
        >
          <div className="p-3 bg-slate-50 rounded-xl text-[var(--app-primary)]">
          ...
          <div>
            ...
            <button 
              ...
              className="text-xs text-[var(--app-primary)] font-medium hover:underline mt-1.5 flex items-center"
            >
        ...
        <motion.div 
          ...
          className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex items-start space-x-4"
        >
          <div className="p-3 bg-[var(--app-primary-soft)] rounded-xl text-[var(--app-primary)]">
            <Sparkles className="w-6 h-6" />
          </div>
          <div>
            <span className="text-xs font-semibold text-slate-400 block tracking-wider uppercase">Total Savings</span>
            <span className="text-2xl font-bold text-[var(--app-primary)] block mt-0.5">
              ${(paperlessOffer.active ? 36 : 0) + (isBundleApplied ? 540 : 0)}/yr
            </span>
            <span className="text-[11px] text-[var(--app-primary)] font-medium block mt-1">Active discounts</span>
          </div>
        </motion.div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs">
            <div className="flex items-center justify-between mb-5 border-b border-slate-100 pb-4">
              ...
              <button 
                onClick={() => onNavigateToTab('policies')}
                className="text-xs font-semibold text-[var(--app-primary)] hover:underline flex items-center"
              >
                  ...
                  >
                    <div className="flex items-start space-x-3.5">
                      <div className={`p-2.5 rounded-lg shrink-0 mt-0.5 ${
                        isAuto ? 'bg-slate-100 text-[var(--app-primary)]' : 'bg-orange-100/70 text-orange-700'
                      }`}>
                    ...
                    <div className="flex items-center gap-3 shrink-0 pt-3 md:pt-0 border-t md:border-t-0 border-slate-100 justify-end">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-[var(--app-primary)]/5 hover:bg-[var(--app-primary)]/10 text-[var(--app-primary)] text-xs font-bold rounded-lg transition-all"
                      >
                        View Limits
                      </button>
                    </div>
