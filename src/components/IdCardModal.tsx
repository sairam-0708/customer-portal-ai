        ...
        <html>
          <head>
            ...
            <style>
              ...
              .card { border: 2px solid var(--app-primary); border-radius: 8px; padding: 24px; max-width: 500px; margin: 0 auto; }
              .header { border-bottom: 2px solid var(--app-primary); padding-bottom: 12px; margin-bottom: 16px; }
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-[var(--app-primary)] text-white">
          <div className="flex items-center space-x-2">
            <Shield className="w-5 h-5 fill-white text-[var(--app-primary)]" />
        ...
        <div className="p-6 space-y-6">
          ...
          <div 
            ref={cardRef}
            className="border-2 border-[var(--app-primary)] rounded-xl p-5 bg-slate-50 relative overflow-hidden shadow-inner"
            id="id-card-canvas"
          >
            {/* Watermark logo */}
            <div className="absolute right-4 bottom-4 opacity-[0.03] select-none pointer-events-none">
              <Shield className="w-48 h-48 text-[var(--app-primary)]" />
            </div>

            {/* Top Row Logo */}
            <div className="flex justify-between items-start border-b border-[var(--app-primary)]/30 pb-3 mb-4">
              <div>
                <span className="font-bold text-lg tracking-wider text-[var(--app-primary)] block font-sans">S H I E L D G U A R D</span>
            ...
            <div className="grid grid-cols-2 gap-y-3.5 gap-x-4 text-xs font-sans">
              ...
              <div className="col-span-2 border-t border-[var(--app-primary)]/10 pt-3 flex justify-between items-center text-[10px] text-slate-500">
          ...
          <div className="flex items-center justify-between gap-4 pt-2">
            <button
              onClick={handlePrint}
              className="flex-1 py-3 px-4 bg-[var(--app-primary)] hover:bg-[var(--app-primary-hover)] text-white rounded-xl text-sm font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center space-x-2 cursor-pointer"
              id="print-proof-btn"
            >
