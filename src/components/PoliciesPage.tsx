  ...
  return (
    <div className="space-y-8" id="policies-page-wrapper">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-200 pb-4 gap-4">
        <div>
          <span className="text-xs font-bold tracking-wider text-[#004f8f] block uppercase font-sans">ShieldGuard Coverages</span>
        ...
        <button
          ...
          className="px-4 py-2.5 bg-[#004f8f] hover:bg-[#003d70] text-white text-xs font-bold rounded-xl flex items-center gap-1.5 transition-all shadow-xs self-start md:self-auto"
        >
      ...
      <AnimatePresence>
        {showQuoteForm && (
          ...
          >
            <div className="bg-gradient-to-r from-blue-50 to-[#f0f6fa] border border-blue-200 rounded-2xl p-6 relative">
              <button 
              ...
              <div className="flex items-center space-x-2 mb-4">
                <Sparkles className="w-5 h-5 text-[#004f8f]" />
              ...
              {!calculatedQuote ? (
                <form onSubmit={handleCalculateQuote} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                  ...
                  <button
                    type="submit"
                    className="w-full py-2.5 bg-[#004f8f] hover:bg-[#003d70] text-white font-bold text-xs rounded-lg transition-colors shadow-xs"
                  >
                    Calculate Premium
                  </button>
                </form>
              ) : (
                <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-white border border-blue-100 rounded-xl gap-4">
                  <div>
                    <span className="text-[10px] uppercase font-bold tracking-wider text-blue-600">Calculated ShieldGuard Rate Quote</span>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <span className="text-2xl font-bold text-[#004f8f] block">${calculatedQuote}.00</span>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-3 rounded-2xl border border-slate-200/80">
        <div className="flex items-center gap-1.5 p-1 bg-slate-50 border border-slate-200/40 rounded-xl">
          <button
            ...
            className={`px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-all ${
              activeTab === 'all' 
                ? 'bg-[#004f8f] text-white shadow-xs' 
        ...
        <div className="relative">
          <input
            ...
            className="w-full sm:w-64 pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-xs placeholder-slate-400 outline-none focus:ring-2 focus:ring-[#004f8f] focus:border-transparent"
          />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" id="policies-main-grid">
        {filteredPolicies.map((policy) => {
          ...
          return (
            ...
            >
              {/* Card Title Banner */}
              <div className="bg-[#004f8f] p-5 text-white flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="bg-white/10 p-2.5 rounded-xl">
                    {isAuto ? <Car className="w-5 h-5" /> : <HomeIcon className="w-5 h-5" />}
                  </div>
                  <div>
                    <span className="text-[10px] tracking-widest text-blue-200 uppercase font-bold block">
                  ...
                  {isAdjusting && (
                    ...
                    >
                      <div className="flex items-center gap-1.5 text-xs font-bold text-slate-700">
                        <Sliders className="w-3.5 h-3.5 text-[#004f8f]" />
                      ...
                      {isAuto ? (
                              ...
                              <button
                                ...
                                className={`flex-1 py-1.5 border rounded-lg text-xs font-bold transition-all ${
                                  simulatedDeductible === val 
                                    ? 'bg-[#004f8f] border-[#004f8f] text-white shadow-xs' 
                        ...
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full accent-[#004f8f]"
                          />
                      ...
                      <div className="flex items-center justify-between p-2.5 bg-blue-50 rounded-lg border border-blue-100">
                        <span className="text-[10px] font-bold text-[#004f8f] uppercase">Simulated Premium Rate</span>
                        <span className="text-sm font-black text-[#004f8f]">
                      ...
                      <div className="flex gap-2 justify-end">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 bg-[#004f8f] text-white text-[10px] font-bold rounded-lg hover:bg-[#003d70] transition-colors"
                        >
                          Save Adjustments
                        </button>
                      </div>
              ...
              <div className="px-5 py-4 bg-slate-50 border-t border-slate-100 flex flex-wrap gap-2 justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-[#004f8f]/10 text-[#004f8f] hover:bg-[#004f8f]/20 text-xs font-bold rounded-lg transition-colors"
                  >
